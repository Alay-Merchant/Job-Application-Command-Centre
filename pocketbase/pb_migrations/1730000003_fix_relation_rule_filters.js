...
// Relation filters are evaluated against the collection fields, not raw
// request-body strings. This migration corrects the first hardening migration
// for existing PocketBase databases.
migrate((app) => {
